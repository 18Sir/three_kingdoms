...
public class Result<T> {
    ...
    public static <E> Result<E> selectSuccess(E data,String msg){
        return new Result<>(ResultCode.SELECT_OK,msg,data);
    }

    public static <E> Result<E> updateSuccess(){
        return new Result<>(ResultCode.UPDATE_OK,"更新成功",null);
    }
    public static <E> Result<E> updateSuccess(String msg){
        return new Result<>(ResultCode.UPDATE_OK,msg,null);
    }

    public static <E> Result<E> saveSuccess(){
        return new Result<>(ResultCode.SAVE_OK,"添加成功",null);
    }
    public static <E> Result<E> saveSuccess(String msg){
        return new Result<>(ResultCode.SAVE_OK,msg,null);
    }

    public static <E> Result<E> deleteSuccess(){
        return new Result<>(ResultCode.DELETE_OK,"删除成功",null);
    }
    public static <E> Result<E> deleteSuccess(String msg){
        return new Result<>(ResultCode.DELETE_OK,msg,null);
    }
    ...
    public static <E> Result<E> selectError(String msg){
        return new Result<>(ResultCode.SELECT_ERR,msg,null);
    }

    public static <E> Result<E> saveError(){
        return new Result<>(ResultCode.SAVE_ERR,"添加失败",null);
    }
    public static <E> Result<E> saveError(String msg){
        return new Result<>(ResultCode.SAVE_ERR,msg,null);
    }

    public static <E> Result<E> deleteError(){
        return new Result<>(ResultCode.DELETE_ERR,"删除失败",null);
    }
    public static <E> Result<E> deleteError(String msg){
        return new Result<>(ResultCode.DELETE_ERR,msg,null);
    }

    public static <E> Result<E> updateError(){
        return new Result<>(ResultCode.UPDATE_ERR,"修改失败",null);
    }
    public static <E> Result<E> updateError(String msg){
        return new Result<>(ResultCode.UPDATE_ERR,msg,null);
    }
    ...
    public static <E> Result<E> error(ResultCode code,E data,String msg){
        return new Result<>(code,msg,data);
    }
}
